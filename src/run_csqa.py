...
def train(args, train_dataset, model, tokenizer):
    ...
    if args.local_rank in [-1, 0]:
        tb_writer = SummaryWriter(os.path.join(project_root, 'tb_logs',
                                               "{}_{}_{}_{}".format(args.task_name, args.model_type,
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False, test=False):
    ...
    features = convert_examples_to_features(examples, tokenizer, label_list=label_list, max_length=args.max_seq_length,
                                            ...
                                            max_path=args.max_concepts, max_path_len=args.max_concept_len,
...
def main():
    ...
    model.core = model.core.from_pretrained(args.model_name_or_path, from_tf=bool('.ckpt' in args.model_name_or_path),
    ...
    with open(os.path.join(project_root, "running_times",
                           "{}_{}_{}_{}.json".format(args.task_name, args.model_type,
                                                     args.model_name_or_path.split('/')[-1],
                                                     current_time)), 'w') as fp:
